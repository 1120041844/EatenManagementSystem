...
public class DianjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DianjiaEntity user = dianjiaService.selectOne(new EntityWrapper<DianjiaEntity>().eq("dianjiazhanghao", username));
    ...
    public R register(@RequestBody DianjiaEntity dianjia){
    	...
    	DianjiaEntity user = dianjiaService.selectOne(new EntityWrapper<DianjiaEntity>().eq("dianjiazhanghao", dianjia.getDianjiazhanghao()));
		if(user!=null) {
